 ...
 * 
 */
package pt.ist.messaging.domain.legacy;
...
import pt.ist.messaging.domain.MessagingSystem;
...
public class SenderGroup extends SenderGroup_Base {
    ...
    public String getName() {
        return BundleUtil.getString("resources/MessagingResources", getNameLable());
    }
